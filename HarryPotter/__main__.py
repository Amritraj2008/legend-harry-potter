...
from HarryPotter.plugins.helper_funcs.chat_status import is_user_admin
from HarryPotter.plugins.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="Support", url="https://t.me/tech_sav_bots"),
    ],
    [
        InlineKeyboardButton(
...
❍ I check for admins' permissions before executing any command and more stuffs
                 ...
                 Here is the [💾Repository](https://github.com/amritraj2008).
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Harry Potter*
                 \nHere is the [Source Code](https://github.com/amritraj2008) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1152303959 and DONATION_LINK:
            update.effective_message.reply_text(
